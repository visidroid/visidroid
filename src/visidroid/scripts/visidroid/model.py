...
def get_vision_assistant_message(system_message, user_messages, assistant_messages=[], functions=[], model="gpt-4-turbo-2024-04-09", max_tokens=MAX_TOKENS, base64_image=[]):
    start_time = time.time()
